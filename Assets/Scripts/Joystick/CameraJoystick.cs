...
public class CameraJoystick : MonoBehaviour,IDragHandler, IPointerUpHandler, IPointerDownHandler//ekrana dokunulurken ve ekran b�rak�ld���nda durumlar� i�in
                                                                               //gerekli metotlar� kullanabilmek i�in ekledi�imiz interfaceler
{
    [SerializeField] private float maxRange = 100f; //joystickin uzakla�abilece�i max mesafe
    ...
    public void ChangeAbleToInteract()
    {
